...
#import soft_renderer123.cuda.create_texture_image as create_texture_image_cuda
...
def create_texture_image(textures, texture_res=16):
    ...
    image = sr.cuda.create_texture_image.create_texture_image(vertices, textures, image, 1e-5)
